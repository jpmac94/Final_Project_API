...
public class UsuarioMain implements UserDetails {
    ...
    //Constructor
    public UsuarioMain(String nombre, String usuario, String email, String password, Collection<? extends GrantedAuthority> authorities, boolean enabled) {
        this.nombre = nombre;
    ...
    public static UsuarioMain build(Usuario usuario){
        ...
        return new UsuarioMain(usuario.getNombre(), usuario.getNombreUsuario(), usuario.getEmail(),
                usuario.getPassword(), authorities, usuario.isEnabled());
    }
